        ...
        <div className="container relative mx-auto w-full px-4 pb-10 pt-6 sm:px-6 sm:pb-12 sm:pt-8 lg:px-8">
          <div className="mx-auto space-y-4 text-center">
            ...
            <h1 className="text-3xl font-bold leading-tight tracking-tight sm:text-4xl lg:text-5xl">
              ...
              <span className="text-foreground"> para Molina Matta y asociados</span>
            </h1>
        ...
        <article className="space-y-10">
          <section className="space-y-4">
            ...
            <div className="space-y-4 text-muted-foreground leading-relaxed">
              <p>
                El objetivo de esta propuesta es diseñar e implementar, junto a Molina Matta y asociados, un plan de
              ...
              <div className="container relative mx-auto w-full px-4 sm:px-6 lg:px-8">
                <div className="space-y-4">
                  ...
                  <div className="space-y-4 text-muted-foreground leading-relaxed">
                    ...
                    <p>
                      El objetivo es entregar a Molina Matta y asociados una hoja de ruta a medida, capaz de escalar junto
