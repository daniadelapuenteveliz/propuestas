...
import PackageBreakdownSection from '../components/proposals/PackageBreakdownSection';
import PackageSimulationSection from '../components/proposals/PackageSimulationSection';
import type { Proposal } from '../config/proposals';
...
export default function PropuestaJudicial1({ proposal }: { proposal: Proposal }) {
  const { header, scope } = proposal;
          ...
          <div className="mx-auto space-y-4 text-center">
            <div className="flex items-center justify-center gap-3">
              ...
              <span className="inline-flex items-center gap-2 rounded-full border border-primary/30 bg-gradient-to-r from-primary/15 to-primary-glow/10 px-4 py-1.5 text-xs font-semibold uppercase tracking-[0.2em] text-primary shadow-glow">
                {header.showBadgeIcon ? <Scale className="h-3.5 w-3.5" /> : null}
                {header.badgeLabel}
              </span>
            </div>
            ...
            <h1 className="text-3xl font-bold leading-tight tracking-tight sm:text-4xl lg:text-5xl">
              ...
              <span className="text-foreground">{header.titleSuffix}</span>
            </h1>
      ...
      <main className="container mx-auto w-full px-4 pt-5 pb-10 sm:px-6 sm:pt-6 sm:pb-12 lg:px-8">
        <article className="space-y-10">
          ...
          <section className="space-y-4">
            <h2 className="text-xl font-semibold text-foreground">{scope.title}</h2>
          ...
          <div className="proposal-full-bleed relative left-1/2 -mt-5 -ml-[50vw] w-screen max-w-[100vw] sm:-mt-5">
            ...
            <section
              className={`relative overflow-hidden border-b border-primary/20 pt-5 pb-10 sm:pt-6 sm:pb-12${proposal.showPosiblesMejoras ? '' : ' border-t'}`}
            >
              <div className="pdf-decorative-gradient pdf-decorative-gradient--primary absolute inset-0 bg-gradient-to-br from-primary/15 via-background to-primary-glow/10" />
              <div className="pdf-decorative-blur absolute -right-20 -top-20 h-72 w-72 rounded-full bg-primary/20 blur-3xl" />
              <div className="pdf-decorative-blur absolute -bottom-24 -left-16 h-56 w-56 rounded-full bg-primary-glow/25 blur-3xl" />
              ...
              <div className="container relative mx-auto w-full px-4 sm:px-6 lg:px-8">
                {proposal.highlightSection.variant === 'numbered-services' ? (
                  <div className="space-y-4">
                    <h2 className="text-xl font-semibold text-foreground">{proposal.highlightSection.title}</h2>
                    <div className="space-y-4 text-muted-foreground leading-relaxed">
                      <p>{proposal.highlightSection.intro}</p>
                      <ol className="list-decimal space-y-1 pl-6">
                        {proposal.highlightSection.items.map((item) => (
                          <li key={item} className="leading-relaxed">
                            {item}
                          </li>
                        ))}
                  ...
                  <>
                    <PackageBreakdownSection
                      title={proposal.highlightSection.title}
                      blocks={proposal.highlightSection.blocks}
                    />
                    {'simulation' in proposal && proposal.simulation ? (
                      <PackageSimulationSection simulation={proposal.simulation} />
                    ) : null}
                  </>
                )}
              </div>
          ...
          {proposal.sections.showKheprionWorkflow ? (
          <section className="space-y-4">
            <h2 className="text-xl font-semibold text-foreground">Flujo de trabajo con KheprionAI</h2>
            <div className="space-y-4 text-muted-foreground leading-relaxed">
              <p>
                KheprionAI desplegará una capa de inteligencia artificial frente a cada canal de comunicación directa
                con los clientes, permitiendo procesar los primeros requerimientos y clasificar los leads de forma
                automática.
              </p>
              <p>
          ...
          {proposal.sections.showProposedWorkflow ? (
          <section className="relative left-1/2 -mt-5 -ml-[50vw] w-screen max-w-[100vw] overflow-hidden border-y border-primary/20 pt-5 pb-10 sm:-mt-5 sm:pt-6 sm:pb-12">
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-4 text-muted-foreground leading-relaxed">
                <p>
                  En todo momento, los clientes podrán hacer seguimiento de su caso contactando al estudio vía WhatsApp o
                  Instagram.
                </p>
              </div>
            </div>
          ...
          {proposal.sections.showAgentCapabilities ? (
          <section className="space-y-4">
            <h2 className="text-xl font-semibold text-foreground">
              Posibles habilidades que pueden tener los agentes
            </h2>
            <div className="space-y-6 text-muted-foreground leading-relaxed">
              <div className="space-y-2">
                <h3 className="text-lg font-medium text-foreground">
                  1) Verificador de Tabla de la Corte (PJUD)
                </h3>
                <p>
              ...
              <div className="space-y-2">
                ...
                <p>
                  Lee fotos, escaneos y PDFs complejos de forma local, sin depender de APIs externas, mediante
                  tecnología OCR y visión artificial. Extrae texto limpio, montos, RUTs y fechas para citarlos
                  directamente en escritos judiciales, reduciendo errores de transcripción.
                </p>
              </div>
              <div className="space-y-2">
                <h3 className="text-lg font-medium text-foreground">
                  3) Catalogador Automatizado de Pruebas Documentales
                </h3>
                <p>
              ...
              <div className="space-y-2">
                <h3 className="text-lg font-medium text-foreground">
                  7) Auditor de Citas Legales (Verificador Ley Chile)
                </h3>
                <p>
              ...
              <div className="space-y-2">
                <h3 className="text-lg font-medium text-foreground">
                  8) Planificador de Juicios Laborales (Defensa Empleador)
                </h3>
                <p>
              ...
              <div className="space-y-2">
                <h3 className="text-lg font-medium text-foreground">
                  9) Solicitador de Antecedentes y Pruebas al Cliente
                </h3>
                <p>
